...
public class JogoDescobrePratos {
	...
	public static void main(String[] args) {
		...
		int liga_desliga = JOptionPane.showConfirmDialog(null, "Vou te tentar adivinhar o prato ques esta pensando.", "Gostaria de Iniciar o Jogo?", JOptionPane.YES_OPTION, JOptionPane.QUESTION_MESSAGE);
